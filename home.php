...
<head>
    ...
    <meta name="description" content="Marcenária Móveis Sob Medida, Ibéria Móveis atendemos em São Paulo">
    ...
    <style amp-custom="">
        ...
        * {
        ...
        .mobi-spinner em:nth-child(1) {
            -webkit-animation-delay: 0.1s;
            background: #f9d5bd;
        }

        .mobi-spinner em:nth-child(2) {
            -webkit-animation-delay: 0.2s;
            background: #bbe0e2;
        }

        .mobi-spinner em:nth-child(3) {
        ...
        .cid-qNzLcQheRk {
            background-image: url("files/12-1920x1280.jpg");
        }
        ...
        .cid-qOxVjlTQtx {
            padding-top: 75px;
            padding-bottom: 75px;
            background-image: url("files/13-1920x1280.jpg");
        }
        ...
        .cid-qOxWhmJdxM {
            padding-top: 75px;
            padding-bottom: 75px;
            background-image: url("files/21-1920x1280.jpg");
        }
        ...
        .cid-ultimos-projetos {
            padding-top: 75px;
            padding-bottom: 75px;
            background-image: url("files/1920x1280-1.jpg");
        }

        .cid-ultimos-projetos .mbr-overlay {
            background-color: #fce1ce;
            opacity: 0.5;
        }

        .cid-ultimos-projetos .carousel-img {
            width: 100%;
            text-align: center;
            margin: 0;
        }

        .cid-ultimos-projetos .container-fluid {
            max-width: 100%;
            padding: 0;
        }

        .cid-ultimos-projetos .amp-carousel-button {
            width: 50px;
            height: 50px;
            border-radius: 50%;
        }

        .cid-ultimos-projetos .mbr-section-subtitle {
            padding-bottom: 2rem;
            color: #7f7e7e;
        }

        .cid-ultimos-projetos .mbr-section-title {
            padding-bottom: 2rem;
        }

        .cid-ultimos-projetos .mbr-text {
            padding-top: 2rem;
            padding-bottom: 0;
            margin: 0;
            color: #7f7e7e;
        ...
        .cid-ultimos-projetos .mbr-section-btn {
            padding-top: 2rem;
        }

        .cid-ultimos-projetos amp-img {
            transition: box-shadow 0.3s;
        }

        .cid-ultimos-projetos amp-img:hover {
            cursor: pointer;
            box-shadow: 0px 0px 80px -10px rgba(0, 0, 0, 0.3);
            -webkit-box-shadow: 0px 0px 80px -10px rgba(0, 0, 0, 0.3);
        }
        ...
        .cid-qNA5xrV33N {
            padding-top: 75px;
            padding-bottom: 75px;
            background-image: url("files/9-1920x1280.jpg");
        }
    ...
    <style>
        ...
        .whatsappme__box {
            ...
            padding-bottom: 60px;
            border-radius: 32px;
            background: #ede4dd url(//www.marcenariagmw.com.br/wp-content/plugins/creame-whatsapp-me/public/images/background.png) center repeat-y;
    ...
    <script async="" custom-element="amp-image-lightbox" src="files/amp-image-lightbox-0.js"></script>
    <script async="" custom-element="amp-fit-text" src="files/amp-fit-text-0.js"></script>
    <script async="" custom-element="amp-iframe" src="files/amp-iframe-0.js"></script>
    <script async="" custom-element="amp-sidebar" src="files/amp-sidebar-0.js"></script>
...
<body style="opacity: 1; visibility: visible; animation: 0s ease 0s 1 normal none running none;"
    ...
    <amp-sidebar id="sidebar"
        ...
        <div class="builder-sidebar" id="builder-sidebar">
            ...
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                <li class="nav-item dropdown open">
                    ...
                    <div class="dropdown-menu">
                        <a class="text-black dropdown-item display-4" href="/cozinhas.html">Cozinhas</a>
                        <a class="text-black dropdown-item display-4" href="/dormitorios.html">Dormitórios</a>
                        <a class="text-black dropdown-item display-4" href="/salas.html">Salas</a>
            ...
            <!-- <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4"
                    href="#orcamento">Solicite um Orçamento</a></div> -->
        </div>
    ...
    <section class="menu horizontal-menu cid-qOlhNl2GjD" id="menu1-gb">
        <nav class="navbar navbar-dropdown  navbar-fixed-top navbar-expand-lg" i-amphtml-fixedid="F0"
            style="top: calc(0px);">
            <div class="navbar-brand">
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-5" href="/index.html" style="font-size: 2.2rem;">Ibéria</a></span>
            </div>
    ...
    <section class="mbr-section content1 cid-qNzQ3o9UUn" id="content1-91">
        <div class="container">
            ...
            <h2 class="mbr-title align-center mbr-fonts-style display-2" style="margin-top: 1rem">Móveis Sob Medida</h2>
        </div>
    </section>
            ...
            <div class="mbr-row mbr-justify-content-center">
                <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-wrapper">
                        <div class="card-img">
                            <a href="/cozinhas.html">
                                <amp-img src="/projetos/cozinhas/10.jpg" layout="responsive" width="349.2505353319058"
                                    height="233" 
                                    ...
                                    <img decoding="async"  src="/projetos/cozinhas/10.jpg"
                ...
                <!-- <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-wrapper">
                        <div class="card-img">
                            ...
                            <amp-img src="files/democard2-700x467.jpg" layout="responsive" height="233"
                                ...
                                <img decoding="async"  src="files/democard2-700x467.jpg"
                                    class="i-amphtml-fill-content i-amphtml-replaced-content">
                            </amp-img>
                            </a>
                        </div>
               ...
               <!--  <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                        <div class="card-wrapper">
                            ...
                            <div class="card-img">
                                <a  href="/3d.html" style="display: hidden;">
                                <amp-img src="files/democard3-700x467.jpg" layout="responsive" height="233"
                                    width="349.2505353319058" 
                                    class="mobi-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                    i-amphtml-layout="responsive" style="--loader-delay-offset:67ms !important;">
                                    <i-amphtml-sizer style="padding-top: 66.7143%;"></i-amphtml-sizer>
                                    ...
                                    <img decoding="async"  src="files/democard3-700x467.jpg"
                                        class="i-amphtml-fill-content i-amphtml-replaced-content">
                                </amp-img>
                            </a>
                            </div>
                ...
                <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 last-child">
                        <div class="card-wrapper">
                            ...
                            <div class="card-img">
                                <a  href="/salas.html" style="display: hidden;">
                                <amp-img src="/projetos/salas/2.jpg" layout="responsive" height="233"
                                    width="349.2505353319058" 
                                    class="mobi-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                    i-amphtml-layout="responsive" style="--loader-delay-offset:67ms !important;">
                                    <i-amphtml-sizer style="padding-top: 66.7143%;"></i-amphtml-sizer>
                                    ...
                                    <img decoding="async"  src="/projetos/salas/2.jpg"
                                        class="i-amphtml-fill-content i-amphtml-replaced-content">
                                </amp-img>
                            </a>
                            </div>
    ...
    <section class="lightbox2 slider cid-ultimos-projetos" id="lightbox2-gk">
            ...
            <div class="slider-box">
                <amp-carousel
                    ...
                    <div class="i-amphtml-scrollable-carousel-container">
                        <amp-img
                            class="carousel-img mobi-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="/projetos/ultimos/1.jpg" on="tap:lightbox1" role="button" tabindex="0" height="400"
                            width="599.2509363295881"  style="width: 599.251px; height: 400px;"
                            i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobi-spinner">
                                    <em></em>
                            ...
                            <img decoding="async"  src="/projetos/ultimos/1.jpg"
                                class="i-amphtml-fill-content i-amphtml-replaced-content">
                        </amp-img>
                        <amp-img
                            class="carousel-img mobi-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="/projetos/ultimos/2.jpg" on="tap:lightbox2" role="button" tabindex="0" height="400" width="600"
                             style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobi-spinner">
                                    <em></em>
                                    <em></em>
                            ...
                            <img decoding="async"  src="/projetos/ultimos/2.jpg"
                                class="i-amphtml-fill-content i-amphtml-replaced-content">
                        </amp-img>
                        <amp-img
                            class="carousel-img mobi-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="/projetos/ultimos/3.jpg" on="tap:lightbox3" role="button" tabindex="0" height="400" width="600"
                             style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobi-spinner">
                                    <em></em>
                            ...
                            <img decoding="async"  src="/projetos/ultimos/3.jpg"
                                class="i-amphtml-fill-content i-amphtml-replaced-content">
                        </amp-img>
                        <amp-img
                            class="carousel-img mobi-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="/projetos/ultimos/4.jpg" on="tap:lightbox5" role="button" tabindex="0" height="400" width="600"
                             style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobi-spinner">
                                    <em></em>
                            ...
                            <img decoding="async"  src="/projetos/ultimos/4.jpg"
                                class="i-amphtml-fill-content i-amphtml-replaced-content">
                        </amp-img>
                        <amp-img
                            class="carousel-img mobi-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="/projetos/ultimos/5.jpg" on="tap:lightbox5" role="button" tabindex="0" height="400" width="600"
                             style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobi-spinner">
                                    <em></em>
                            ...
                            <img decoding="async"  src="/projetos/ultimos/5.jpg"
                                class="i-amphtml-fill-content i-amphtml-replaced-content">
                        </amp-img>
                        <!-- <amp-img
                            class="carousel-img mobi-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide"
                            src="files/06.jpg" on="tap:lightbox6" role="button" tabindex="0" height="400" width="600"
                             style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="">
                                <div class="mobi-spinner">
                                    <em></em>
        ...
        <div class="container">
            <div class="mbr-row main-row">
                <div class="card col-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-row">
                        <div class="card-img align-center">
                            <span class="amp-iconfont fa-credit-card fa"></span>
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style align-center display-5">Parcelamos no cartão</h4>
                            <p class="mbr-text mbr-fonts-style align-center display-7">
                                Parcele em até 12X no Cartão, também oferecemos desconto para pagamento á vista.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card col-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-row">
                        ...
                        <div class="card-box">
                            ...
                            <p class="mbr-text mbr-fonts-style align-center display-7">
                                Oferecemos garantia em todos os nossos móveis.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card col-12 mbr-col-md-6 mbr-col-lg-4 last-child">
                    <div class="card-row">
                        <div class="card-img align-center">
                            <span class="amp-iconfont fa-cube fa"></span>
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style align-center display-5">
                                Projeto 3D personalizado</h4>
                            <p class="mbr-text mbr-fonts-style align-center display-7">
                                Colocamos a sua disposição uma equipe de designer para desenvolver o seu projeto sob
                                medida.
                            </p>
                        </div>
                    </div>
                ...
                <div class="mbr-row first-row mbr-justify-content-center">
                    <div class="mbr-col-md-6">
                        ...
                        <p class="mbr-text text mbr-fonts-style display-7">
                            Email: <a href="mailto:iberiamoveis@gmail.comm">iberiamoveis@gmail.com</a>
    ...
    <section class="cid-default" style="padding: 1rem; background-color: #fce1ce" >
        <div class="mbr-overlay"></div>
        <div class="container align-center">
            <h2 class="title mbr-fonts-style align-center mbr-light display-2" style="margin-bottom: 0px;">Localização
            </h2>
        </div>
    </section>


    <section class="maps2" id="maps2-a">

        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="google-map">

                    <iframe src="https://www.google.com/maps/embed?key=AIzaSyDsmOVpjte6zvtKLK2fma50QUIDdrqImSk&pb=!1m14!1m8!1m3!1d7316.737170417157!2d-46.499788!3d-23.519242!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce6095a2366c21%3A0x1a785f586db516fe!2sR.%20Prof.%20Jos%C3%A9%20de%20Barros%20Pinto%2C%20193b%20-%20Vila%20Frugoli%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2003674-040!5e0!3m2!1spt-BR!2sbr!4v1572806782250!5m2!1spt-BR!2sbr"
                    height="400" layout="fixed-height"
                    sandbox="allow-scripts allow-same-origin allow-popups"
                    class="mobi-loader i-amphtml-element i-amphtml-layout-fixed-height i-amphtml-layout-size-defined i-amphtml-layout"
                    style="height: 400px; width: 100%;" i-amphtml-layout="fixed-height"
                    title="maps"
    ...
    <section class="footer3 cid-qNA6O02OA1" id="footer3-9e" style="background-color: #f4e7dd;">

        <div class="container">
            <div class="mbr-row">
                <div class="mbr-col-sm-12 mbr-col-md-12 text1 mbr-col-lg-4 ">
                    <p class="links mbr-text mbr-fonts-style mbr-bold display-7">
                        Ibéria <br>Móveis Sob Medida
                    </p>
                </div>
            </div>
        </div>
