...
<div class="w3-row-padding w3-container  bg-black" style="padding:64px 32px;" id="contato">
  ...
  <div class="w3-col m6 text-w">
    <p class="mbr-text">
        ...
        <br>
        <a class="text-y" href="https://www.google.com/maps/dir//R.+Prof.+José+de+Barros+Pinto+193C/">
