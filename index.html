<!DOCTYPE html>
<html amp="" amp-version="1910302211460" style="padding-top: 0px !important;"
...
<head>
    ...
    <style amp-extension="amp-image-lightbox">
        amp-image-lightbox {
            position: fixed !important;
            top: 0 !important;
            left: 0 !important;
    ...
    <style amp-extension="amp-fit-text">
    ...
    <meta name="description" content="Ibéria Móveis Sob Medida">
    <title>Ibéria Móveis Sob Medida</title>
    <link rel="stylesheet" href="files/font-awesome.css">
    <link rel="canonical"
        href="https://mobirise.com/html-templates/bootstrap-templates-free-download-for-html5/index.html">
    ...
    <style amp-custom="">
        ...
        * {
        ...
        .cid-qOxWhmJdxM {
            padding-top: 75px;
            padding-bottom: 75px;
            background-image: url("assets/images/21-1920x1280.jpg");
        }

        .cid-qOxWhmJdxM .mbr-overlay {
            background-color: #fce1ce;
            opacity: 0.5;
        }

        .cid-qOxWhmJdxM .mbr-text {
            padding: 0;
            margin: 0;
        }

        .cid-qOxWhmJdxM .section-subtitle {
            color: #7f7e7e;
        }

        .cid-qOxWhmJdxM .text-block {
            margin: auto;
            margin-bottom: 1.5rem;
        }

        .cid-qOxWhmJdxM .slider-box {
            margin: auto;
        }

        .cid-qOxWhmJdxM .slider-box .slide-wrap {
            display: flex;
            align-items: center;
        }

        .cid-qOxWhmJdxM .slider-box .slide-wrap .item-card {
            width: 100%;
        }

        .cid-qOxWhmJdxM .text-content,
        .cid-qOxWhmJdxM .card-img-wrap {
            background: transparent;
        }
        ...
        .cid-qOxWhmJdxM .card-img amp-img img {
            border-radius: 50%;
        }
    ...
    <script async="" custom-element="amp-analytics"
        src="files/amp-analytics-0.js"></script>
    <script async="" custom-element="amp-carousel"
        src="files/amp-carousel-0.js"></script>
    <script async="" custom-element="amp-image-lightbox"
        src="files/amp-image-lightbox-0.js"></script>
    <script async="" custom-element="amp-fit-text"
        src="files/amp-fit-text-0.js"></script>
    <script async="" custom-element="amp-iframe"
        src="files/amp-iframe-0.js"></script>
    <script async="" custom-element="amp-sidebar"
        src="files/amp-sidebar-0.js"></script>


    <script async="" custom-element="amp-loader" data-script="amp-loader" i-amphtml-inserted=""
        src="files/amp-loader-0.js"></script>
    <script async="" custom-element="amp-auto-lightbox" data-script="amp-auto-lightbox" i-amphtml-inserted=""
        src="files/amp-auto-lightbox-0.js"></script>
</head>

<body style="opacity: 1; visibility: visible; animation: 0s ease 0s 1 normal none running none;"
    class="amp-mode-mouse amp-mode-keyboard-active">
    <amp-sidebar id="sidebar"
        class="cid-qOlhNl2GjD i-amphtml-element i-amphtml-layout-nodisplay i-amphtml-overlay i-amphtml-scrollable"
        layout="nodisplay" side="right" i-amphtml-layout="nodisplay" role="menu" tabindex="-1" hidden="">
        <div class="builder-sidebar" id="builder-sidebar">
            ...
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                <li class="nav-item dropdown open">
                    <a class="nav-link link text-black dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true">Projetos</a>
                    <div class="dropdown-menu">
                        <a class="text-black dropdown-item display-4" href="https://mobirise.com/html-templates/shop/index.html">Cozinhas</a>
                    </div>
                </li>
            </ul>

            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="http://mobirise.com/">  Solicitar Orçamento</a></div>
        </div>
        <button class="i-amphtml-screen-reader" tabindex="-1">Fechar</button>
    </amp-sidebar>


    <section class="menu horizontal-menu cid-qOlhNl2GjD" id="menu1-gb">        <nav class="navbar navbar-dropdown  navbar-fixed-top navbar-expand-lg" i-amphtml-fixedid="F0"
            style="top: calc(0px);">
            <div class="navbar-brand">
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-5"> Ibéria</a></span>
            </div>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">

                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    <li class="nav-item dropdown open">
                        <a class="nav-link link text-black dropdown-toggle display-" data-toggle="dropdown-submenu" aria-expanded="true">Projetos</a>

                        <div class="dropdown-menu">
                            <a class="text-black dropdown-item display-4"
                                href="https://mobirise.com/html-templates/shop/index.html">Cozinhas</a>
                        </div>
                    </li>
                </ul>
        ...
        <button on="tap:sidebar.toggle" class="ampstart-btn hamburger sticky-but" i-amphtml-fixedid="F1" style="">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
    ...
    <section class="header1 cid-qNzLcQheRk" id="header1-8w">
    ...
    <section class="mbr-section content1 cid-qNzQ3o9UUn" id="content1-91">
        <div class="container">
            <!--O que fazemos-->
            <h2 class="mbr-title align-center mbr-fonts-style display-2" style="margin-top: 4px;">Móveis Sob Medida</h2>
        </div>
    </section>
            ...
            <div class="mbr-row mbr-justify-content-center">
                <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-wrapper">
                        <div class="card-img">
                            <amp-img src="assets/images/democard1-700x467.jpg" layout="responsive"
                                width="349.2505353319058" height="233" alt="Mobirise"
                                class="mobirise-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                i-amphtml-layout="responsive" style="--loader-delay-offset:68ms !important;">
                                <i-amphtml-sizer style="padding-top: 66.7143%;"></i-amphtml-sizer>
                                <div placeholder="" class="amp-hidden">
                                ...
                                <img decoding="async" alt="Mobirise"
                                    src="files/democard1-700x467.jpg"
                        ...
                        <div class="card-box">
                            ...
                            <p class="mbr-text mbr-fonts-style align-left display-7">
                                Sob medida para casas ou apartamentos.
                            </p>
                           <!--  <div class="mbr-section-btn align-left"><a class="btn btn-sm btn-primary display-4"   href="https://mobirise.com/">
                                   Ver Mais</a></div> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-wrapper">
                        <div class="card-img">
                            <amp-img src="assets/images/democard2-700x467.jpg" layout="responsive" height="233"
                                width="349.2505353319058" alt="Mobirise"
                                class="mobirise-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                i-amphtml-layout="responsive" style="--loader-delay-offset:68ms !important;">
                                <i-amphtml-sizer style="padding-top: 66.7143%;"></i-amphtml-sizer>
                                <div placeholder="" class="amp-hidden">
                                ...
                                <img decoding="async" alt="Mobirise"
                                    src="files/democard2-700x467.jpg"
                                    class="i-amphtml-fill-content i-amphtml-replaced-content">
                            </amp-img>
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style align-left mbr-light display-5">
                                Escritórios</h4>
                            <p class="mbr-text mbr-fonts-style align-left display-7">
                                Projetos para pequenas, médias e grandes empresas.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 last-child">
                    <div class="card-wrapper">
                        <div class="card-img">
                            <amp-img src="assets/images/democard3-700x467.jpg" layout="responsive" height="233"
                                width="349.2505353319058" alt="Mobirise"
                                class="mobirise-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                ...
                                <img decoding="async" alt="Mobirise"
                                    src="files/democard3-700x467.jpg"
                                    class="i-amphtml-fill-content i-amphtml-replaced-content">
                            </amp-img>
                        </div>
                        <div class="card-box">
    ...
    <section class="lightbox2 slider cid-qOxVjlTQtx" id="lightbox2-gk">
        ...
        <div class="container-fluid">
            <div class="container">
                <h2 class="mbr-section-title align-center mbr-fonts-style mbr-bold display-2"><span>  Ultimos Projetos</span></h2>
            ...
            <div class="slider-box">
                <amp-carousel
                    ...
                    height="400" layout="fixed-height" type="carousel" style="height: 400px;"
                    i-amphtml-layout="fixed-height">
                    ...
                    <div class="i-amphtml-scrollable-carousel-container">
                        <amp-img
                            ...
                            src="assets/images/09.jpg" on="tap:lightbox1" role="button" tabindex="0" height="400"
                            width="599.2509363295881" alt="Mobirise" style="width: 599.251px; height: 400px;"
                            i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobirise-spinner">
                                    <em></em>
                        ...
                        <amp-img
                            class="carousel-img mobirise-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="assets/images/10.jpg" on="tap:lightbox2" role="button" tabindex="0" height="400"
                            width="600" alt="Mobirise" style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobirise-spinner">
                                    <em></em>
                                    <em></em>
                        ...
                        <amp-img
                            class="carousel-img mobirise-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="assets/images/0311.jpg" on="tap:lightbox3" role="button" tabindex="0" height="400"
                            width="600" alt="Mobirise" style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobirise-spinner">
                                    <em></em>
                        ...
                        <amp-img
                            class="carousel-img mobirise-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="assets/images/04.jpg" on="tap:lightbox4" role="button" tabindex="0" height="400"
                            width="600" alt="Mobirise" style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobirise-spinner">
                                    <em></em>
                        ...
                        <amp-img
                            class="carousel-img mobirise-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide i-amphtml-layout"
                            src="assets/images/05.jpg" on="tap:lightbox5" role="button" tabindex="0" height="400"
                            width="600" alt="Mobirise" style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobirise-spinner">
                                    <em></em>
                        ...
                        <amp-img
                            class="carousel-img mobirise-loader i-amphtml-element i-amphtml-layout-fixed i-amphtml-layout-size-defined amp-carousel-slide amp-scrollable-carousel-slide"
                            src="assets/images/06.jpg" on="tap:lightbox6" role="button" tabindex="0" height="400"
                            width="600" alt="Mobirise" style="width: 600px; height: 400px;" i-amphtml-layout="fixed">
                            <div placeholder="">
                                <div class="mobirise-spinner">
                                    <em></em>
                    ...
                    <div tabindex="0" class="amp-carousel-button amp-carousel-button-prev amp-disabled"
                        role="presentation" title="Previous item in carousel" aria-disabled="true"></div>
        ...
        <amp-image-lightbox id="lightbox1" layout="nodisplay" class="i-amphtml-element i-amphtml-layout-nodisplay"
            i-amphtml-layout="nodisplay" hidden=""></amp-image-lightbox>
        <amp-image-lightbox id="lightbox2" layout="nodisplay" class="i-amphtml-element i-amphtml-layout-nodisplay"
            i-amphtml-layout="nodisplay" hidden=""></amp-image-lightbox>
        <amp-image-lightbox id="lightbox3" layout="nodisplay" class="i-amphtml-element i-amphtml-layout-nodisplay"
            i-amphtml-layout="nodisplay" hidden=""></amp-image-lightbox>
        <amp-image-lightbox id="lightbox4" layout="nodisplay" class="i-amphtml-element i-amphtml-layout-nodisplay"
            i-amphtml-layout="nodisplay" hidden=""></amp-image-lightbox>
        <amp-image-lightbox id="lightbox5" layout="nodisplay" class="i-amphtml-element i-amphtml-layout-nodisplay"
            i-amphtml-layout="nodisplay" hidden=""></amp-image-lightbox>
        <amp-image-lightbox id="lightbox6" layout="nodisplay" class="i-amphtml-element i-amphtml-layout-nodisplay"
            i-amphtml-layout="nodisplay" hidden=""></amp-image-lightbox>    </section>

    <section class="mbr-section content1 cid-qNzXHD1s7j" id="content1-9a">        <div class="container">
            <!--<h2 class="mbr-title align-center mbr-fonts-style display-2">  Our Services</h2>-->


        </div>
    </section>

    <section class="features7 cid-qNzO9fSDY2" id="features7-8z">        <div class="container">
            <div class="mbr-row main-row">
                <div class="card col-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-row">
                        <div class="card-img align-center">
                            <span class="amp-iconfont fa-tv fa"></span>
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style align-center display-5">Parcelamos no cartão</h4>
                            <p class="mbr-text mbr-fonts-style align-center display-7">
                                    Parcele seus móveis sob medida em até 12X no Cartão, também oferecemos desconto para pagamento á vista.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card col-12 mbr-col-md-6 mbr-col-lg-4 first-row-card">
                    <div class="card-row">
                        <div class="card-img align-center">
                            <span class="amp-iconfont fa-bathtub fa"></span>
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style align-center display-5">
                                    Móveis com garantia</h4>
                            <p class="mbr-text mbr-fonts-style align-center display-7">
                                    Oferecemos Garantia de Fábrica em todos os nossos móveis sob medida.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card col-12 mbr-col-md-6 mbr-col-lg-4 last-child">
                    <div class="card-row">
                        <div class="card-img align-center">
                            <span class="amp-iconfont fa-hotel fa"></span>
                        </div>
                        <div class="card-box">
                            <h4 class="card-title mbr-fonts-style align-center display-5">
                                    Projeto 3D personalizado</h4>
                            <p class="mbr-text mbr-fonts-style align-center display-7">
                                    Colocamos a sua disposição uma equipe de designer para desenvolver o seu projeto sob medida.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!--clientes-->
    <!-- <section class="testimonials-slider3 slider cid-qOxWhmJdxM" id="testimonials-slider3-gm"> 
        <div class="mbr-overlay"></div>
        <div class="container align-center">
            ...
            <div class="slider-box mbr-col-sm-12 mbr-col-md-10 mbr-col-lg-8" data-autoplay="true" data-delay="3000">
                <amp-carousel
                    class="carousel testimonials-slider i-amphtml-element i-amphtml-notbuilt amp-notbuilt i-amphtml-layout-fixed-height i-amphtml-layout-size-defined i-amphtml-carousel-has-controls"
                    layout="fixed-height" type="slides" height="550" autoplay="autoplay" delay="3000"
                    style="height: 550px;" i-amphtml-layout="fixed-height">

                    <div class="slide-wrap">
                        <div class="item-card">
                            <div class="card-img-wrap">
                                <div class="card-img">
                                    <amp-img src="assets/images/face1.jpg" layout="responsive" height="550" width="550"
                                        alt="Mobirise"
                                        class="mobirise-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                        i-amphtml-layout="responsive">
                            ...
                            <div class="text-wrap">
                                <div class="text-content">
                                    <p class="mbr-fonts-style mbr-text card-text display-7">
                                        This company employs specialists,
                                        consulted them with the question of design, I was pleased with how they
                                        reacted to the solution of my question. Excellent company!
                                    </p>
                                    <p class="mbr-fonts-style mbr-text card-signature mbr-bold display-7">
                                        John Smith
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="slide-wrap">
                        <div class="item-card">
                            <div class="card-img-wrap">
                                <div class="card-img">
                                    <amp-img src="assets/images/face2.jpg" layout="responsive" height="550" width="550"
                                        alt="Mobirise"
                                        class="mobirise-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                        i-amphtml-layout="responsive">
                                        <i-amphtml-sizer style="padding-top: 100%;"></i-amphtml-sizer>
                            ...
                            <div class="text-wrap">
                                <div class="text-content">
                                    <p class="mbr-fonts-style mbr-text card-text display-7">
                                        ...
                                        done, we are very glad that you embodied our ideas in reality, saved us
                                        from shopping around for materials, saved us a lot of time. It turned
                                        out just fine, we hope for further cooperation.
                                    </p>
                                    <p class="mbr-fonts-style mbr-text card-signature mbr-bold display-7">
                                        John Smith
                                    </p>
                    ...
                    <div class="slide-wrap">
                        <div class="item-card">
                            <div class="card-img-wrap">
                                <div class="card-img">
                                    <amp-img src="assets/images/face3.jpg" layout="responsive" height="550" width="550"
                                        alt="Mobirise"
                                        class="mobirise-loader i-amphtml-element i-amphtml-layout-responsive i-amphtml-layout-size-defined i-amphtml-layout"
                                        i-amphtml-layout="responsive">
                                        <i-amphtml-sizer style="padding-top: 100%;"></i-amphtml-sizer>
                            ...
                            <div class="text-wrap">
                                <div class="text-content">
                                    <p class="mbr-fonts-style mbr-text card-text display-7">
                                        ...
                                        professional work, efficiency, and quality! The team did an excellent
                                        job! I am very pleased! I will definitely recommend you to all my
   ...
   <!--  <section class="social-buttons1 cid-qNA5xrV33N" id="social-buttons1-9c">
        ...
        <div class="mbr-overlay"></div>
        <div class="container align-center">
            <h2 class="title mbr-fonts-style align-center mbr-light display-2">
                Siga-nos</h2>
            <div class="icons-list">
                ...
                <a href="http://www.youtube.com/channel/UCt_tncVAetpK5JeM8L-8jyw" target="_blank">
                    ...
                    <span class="amp-iconfont fa-linkedin-square fa"></span></a><a
                    href="https://www.pinterest.com/mobirise/" target="_blank">
...
<p>Visite nossa página no Instagram</p>
</div>
</a>
...
<path d="m405.02 361.5c-6.176 17.44-30.688 31.904-50.24 36.128-13.376 2.848-30.848 5.12-89.664-19.264-75.232-31.168-123.68-107.62-127.46-112.58-3.616-4.96-30.4-40.48-30.4-77.216s18.656-54.624 26.176-62.304c6.176-6.304 16.384-9.184 26.176-9.184 3.168 0 6.016 0.16 8.576 0.288 7.52 0.32 11.296 0.768 16.256 12.64 6.176 14.88 21.216 51.616 23.008 55.392 1.824 3.776 3.648 8.896 1.088 13.856-2.4 5.12-4.512 7.392-8.288 11.744s-7.36 7.68-11.136 12.352c-3.456 4.064-7.36 8.416-3.008 15.936 4.352 7.36 19.392 31.904 41.536 51.616 28.576 25.44 51.744 33.568 60.032 37.024 6.176 2.56 13.536 1.952 18.048-2.848 5.728-6.176 12.8-16.416 20-26.496 5.12-7.232 11.584-8.128 18.368-5.568 6.912 2.4 43.488 20.48 51.008 24.224 7.52 3.776 12.48 5.568 14.304 8.736 1.792 3.168 1.792 18.048-4.384 35.52z" fill="#00b100"></path>
</svg>
...
<p>Entre em contato pelo whatsapp</p>
    ...
    <section class="footer6 map cid-qNA62GD52W" id="footer6-9d">        
        <div class="container">

            <div class="mbr-row mbr-justify-content-center main-row">
               <div class="mbr-col-lg-6 mbr-col-md-12 map-wrap">
                    <div class="google-map">
                        <amp-iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3658.368571739378!2d-46.501976185023054!3d-23.51924248470375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce6095a2366c21%3A0x1a785f586db516fe!2sR.%20Prof.%20Jos%C3%A9%20de%20Barros%20Pinto%2C%20193b%20-%20Vila%20Frugoli%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2003674-040!5e0!3m2!1spt-BR!2sbr!4v1572749154563!5m2!1spt-BR!2sbr"
                            height="400" layout="fixed-height"
                            sandbox="allow-scripts allow-same-origin                                 allow-popups"
                            frameborder="0"
                            class="mobirise-loader i-amphtml-element i-amphtml-layout-fixed-height i-amphtml-layout-size-defined i-amphtml-layout"
                            style="height: 400px;" i-amphtml-layout="fixed-height">
                            <div placeholder="" class="amp-hidden">
                                <div class="mobirise-spinner">
                                    <em></em>
                                    <em></em>
                            ...
                            <i-amphtml-scroll-container class="amp-active"><iframe class="i-amphtml-fill-content"
                                    name="amp_iframe1" style="z-index: 0;" allow=""
                                    sandbox="allow-scripts allow-same-origin                                 allow-popups"
                                    src="files/place.htm"
                                    frameborder="0"></iframe></i-amphtml-scroll-container>
                        </amp-iframe>
                    </div>
                </div>

               
                <div class="mbr-col-md-12 mbr-col-lg-6">
                    <div class="mbr-row first-row mbr-justify-content-center">
                        <div class="mbr-col-md-6">
                            ...
                            <p class="mbr-text text mbr-fonts-style display-7">
                                Rua Professor José de Barros Pinto, 193 B
                                <br> Vila Frugoli (São Paulo)
                            </p>
                        </div>

                    </div>
                    <div class="mbr-row second-row mbr-justify-content-center">
                        <div class="mbr-col-md-6">
                            <h3 class="mbr-text mbr-bold mbr-fonts-style group-title display-5">
                                Contato
                            </h3>
                            <p class="mbr-text text mbr-fonts-style display-7">
                                Email: iberiamoveis@gmail.com
                                <br>Telefone: (11) 3756-2605 / (11) 98252-3165
                            </p>
                        </div>

                    </div>

                    <div class="mbr-row third-row mbr-justify-content-center">
                            <div class="mbr-col-md-6">
                                    <h3 class="mbr-text mbr-bold mbr-fonts-style group-title display-5">
                                            Atendimento
                                    </h3>
                                    <p class="mbr-text text mbr-fonts-style display-7">
                                            Segunda à Sexta das 09:00h às 18:00h.
                                    </p>
                                </div>
    ...
    <section class="footer3 cid-qNA6O02OA1"  style="background-color: #fce1ce;" id="footer3-9e">
        <div class="container">
            <div class="mbr-row mbr-justify-content-center align-center">
                <div class="mbr-col-sm-12 mbr-col-md-12 text1 mbr-col-lg-4 pbtm">
                   
                </div>
                <div class="mbr-col-sm-12 mbr-col-md-12 text2 mbr-col-lg-4 pbtm">
                    <p class="copyright mbr-text mbr-fonts-style mbr-bold display-7">
                        Ibéria Móveis Sob Medida
                    </p>
                </div>
                <div class="mbr-col-sm-12 mbr-col-md-12 icons-wrap mbr-col-lg-4">
                    <div class="social-list">
                        ...
                        <div class="soc-item">
                            <a href="https://www.facebook.com/pages/Mobirise/1616226671953247" target="_blank">
                                <span class="amp-iconfont fa-facebook fa"></span>
                            </a>
                        </div>
                        <div class="soc-item">
