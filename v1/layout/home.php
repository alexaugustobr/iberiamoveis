...
<section class="bg-light page-section" id="portfolio">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item"> <a class="portfolio-link" href="/projetos.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content"> <i class="fas fa-plus fa-3x"></i> </div>
                    </div> <img class="img-fluid" src="/img/cozinhas.jpg" alt="">
                </a>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item"> <a class="portfolio-link" href="/projetos.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content"> <i class="fas fa-plus fa-3x"></i> </div>
                    </div> <img class="img-fluid" src="/img/dormitorios.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Dormitórios</h4>
                </div>
            ...
            <div class="col-md-4 col-sm-6 portfolio-item"> <a class="portfolio-link" href="/projetos.php">
                    <div class="portfolio-hover">
                        <div class="portfolio-hover-content"> <i class="fas fa-plus fa-3x"></i> </div>
                    </div> <img class="img-fluid" src="/img/salas.jpg" alt="">
                </a>
                <div class="portfolio-caption">
                    <h4>Salas</h4>
                </div>
...
<section class="page-section" id="diferencial">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">Diferencial</h2>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4"> <span class="fa-stack fa-2x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-credit-card fa-stack-1x fa-inverse"></i> </span>
            ...
            <div class="col-md-4"> <span class="fa-stack fa-2x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-bed fa-stack-1x fa-inverse"></i> </span>
                <h4 class="service-heading">Móveis com garantia</h4>
                <p class="text-muted">Oferecemos garantia nos nossos móveis.</p>
            </div>
            <div class="col-md-4"> <span class="fa-stack fa-2x"> <i class="fas fa-circle fa-stack-2x text-primary"></i> <i class="fas fa-cube fa-stack-1x fa-inverse"></i> </span>
