  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading text-uppercase">Móveis Sob Medida</div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" href="/projetos.php">
        ...
        <div class="media-container-row content mbr-white">
            <div class="col-12 col-md-6 mbr-fonts-style display-7">
                <p class="mbr-text">
                    ...
                    <br>
                    <br>Instagram: <a href="https://www.instagram.com/iberiamoveis">@iberiamoveis</a>
                    <br>
                </p>
            </div>
  ...
  <footer class="footer">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-4">
          <span class="copyright">2008-2019</span>
        </div>
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            <li class="list-inline-item">
              <a href="https://www.instagram.com/iberiamoveis">
